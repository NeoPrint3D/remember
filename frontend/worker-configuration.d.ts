/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7300741c1a97455e9238a21119a61a48)
...
declare namespace Cloudflare {
	...
	interface Env {
		NODE_ENV: string;
		USAFA_CALENDAR_USERNAME: string;
		USAFA_CALENDAR_PASSWORD: string;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "USAFA_CALENDAR_USERNAME" | "USAFA_CALENDAR_PASSWORD">> {}
}
